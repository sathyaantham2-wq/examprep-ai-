...
**Added 2026-09-23 at the user's request:** CBSE Class 8 Mathematics, NCERT *Ganita Prakash* Grade 8 (subject code `MATH8`, sources `hegp101`–`hegp107` for Part I and `hegp201`–`hegp207` for Part II, concept codes `C8M-n.m`, authored files in `content/authoring/class8/`). Part I (chapters 1–7) is fully loaded as of 2026-09-24; Part II (7 chapters, sources already extracted to `content/sources/class8m2/`) is next. The owner also supplied NCERT books for Classes 6, 7 Science/Social, 8 Social/Science, 9 Science and 10 under `New folder/` — roughly 130 unauthored chapters. No F-number covers any of this.
